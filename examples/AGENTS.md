...
These instructions extend the repository-root `AGENTS.md` for `examples/`.

- Examples are executable consumer code, not pseudocode.
- Keep domain models and services independent of Click and MCP.
